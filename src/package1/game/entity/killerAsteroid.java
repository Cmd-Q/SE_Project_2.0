        ...
        if(ent.getClass() == Ship.class) {
            ...
            SoundEffect.BONK.play();
             ...
             if(ent.getClass() == Bullet.class){
                ...
                SmallKiller a = (new SmallKiller(new Movement(ent.getPosition()), new Movement(randomNumber, randomNumber2), killerAsteroid.getSize()));
                double randomNumber3 = -3 + (3 + 3) * rand.nextDouble();
                double randomNumber4 = -3 + (3 + 3) * rand.nextDouble();
                SmallKiller b = (new SmallKiller(new Movement(ent.getPosition()), new Movement(randomNumber3, randomNumber4), killerAsteroid.getSize()));
